...
function Obstacles(obstacleNumber) {
  this.positionX = this.getRandomPositionX1(); //posicion del LEFT
  this.positionY = 0; // posicion del TOP
  this.speed = 0;
}
Obstacles.prototype.getRandomPositionX1 = function() {
  return parseInt(Math.floor(Math.random() * ($('.board').width() - 10)));
};
Obstacles.prototype.getRandomPositionX2 = function() {
  return parseInt(Math.floor(Math.random() * ($('.board').width() - 10)));
};
